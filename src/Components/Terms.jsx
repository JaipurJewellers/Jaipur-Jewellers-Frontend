    ...
    <>
      ...
      <div className="font-marcellus max-w-5xl mx-auto p-4 md:p-6 bg-white">
        ...
        <div className="space-y-4 md:space-y-6 text-gray-700 text-sm md:text-base">
          <p>
            This website is operated by Jaipur jwellers. Throughout the site,
            the terms "we", "us" and "our" refer to Jaipur jwellers. Jaipur
            jwellers offers this website, including all information, tools and
        ...
        <div className="mt-6 md:mt-8">
          ...
          <div className="space-y-3 md:space-y-4 text-gray-700 text-sm md:text-base">
            <p>
              ...
              after you have submitted your order). <br /> We undertake no obligation
        ...
        <div className="mt-6 md:mt-8">
          ...
          <div className="space-y-3 md:space-y-4 text-gray-700 text-sm md:text-base">
            ...
            <p>
              In no case shall Jaipur jwellers, our directors, officers,
        ...
        <div className="mt-6 md:mt-8">
          ...
          <div className="space-y-3 md:space-y-4 text-gray-700 text-sm md:text-base">
            <p>
              You agree to indemnify, defend and hold harmless Astronarad and
        ...
        <div className="mt-6 md:mt-8">
          ...
          <div className="space-y-3 md:space-y-4 text-gray-700 text-sm md:text-base">
            <p>
              ...
              you and us and govern your use of the Service, superseding any
        ...
        <div className="mt-6 md:mt-8">
          ...
          <div className="space-y-3 md:space-y-4 text-gray-700 text-sm md:text-base">
            <p>
              ...
              <a
                href="mailto:jaipurjewellers.online@gmail.com"
